...
public class TargetZoneScatteredChart extends ScatterChart {
    protected Paint mYAxisSafeZonePaint;
    private List<TargetZone> mTargetZones;
    public TargetZoneScatteredChart(Context context) {
        super(context);
    }

    public TargetZoneScatteredChart(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public TargetZoneScatteredChart(Context context, AttributeSet attrs, int defStyle) {
